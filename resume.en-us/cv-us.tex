...
\hypersetup{
  ...
  pdfcreator={$ $Id: cv-us.tex, v0.2 6/10/2016 18:35:18 Sylvain Bougerel $ $},
  ...
  pdfkeywords={sylvain bougerel singapore linux unix C++ java C\# distributed
    ...
    agile management gtk valgrind gcc gdb openvz}
}
...
\address{tel: +65 96673473\\
  ...
  \href{https://sg.linkedin.com/in/sylvain-bougerel-397b221}{linkedin: sylvain-bougerel-397b221}
}
...
\begin{resume}
  ...
  As of personal interest, I studied game programming in university and till
...
%%   \end{position}
  ...
  \begin{position}
    ...
    of our offer in coastal surveillance systems and has been sold to 3
